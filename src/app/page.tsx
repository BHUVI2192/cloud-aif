    ...
    <>
      ...
      <section className="relative overflow-hidden bg-white border-b border-line">
        <div className="mx-auto grid max-w-[1180px] items-center gap-14 px-7 py-24 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="card border border-line bg-white shadow-sm" style={{ borderRadius: "24px" }}>
            ...
            {[
              ...
              <div key={l} className="mb-3.5">
                ...
                <div className="input flex items-center justify-between text-[14px] font-medium bg-[#fafcfb] border-line py-2.5">
      ...
      {/* HOW IT WORKS */}
      <section className="mx-auto max-w-[1180px] px-7 py-4">
      ...
      {/* TRUST */}
      <section className="mx-auto grid max-w-[1180px] items-center gap-12 px-7 py-24 md:grid-cols-2 bg-white">
        <div>
        ...
        <div className="grid grid-cols-2 gap-8 rounded-[24px] p-10 border border-line bg-white shadow-sm">
          {[
      ...
      {/* PROVIDER CTA */}
      <section className="mx-auto max-w-[1180px] px-7 py-4">
        <div className="flex flex-wrap items-center justify-between gap-8 rounded-[28px] p-14 text-white" style={{ background: "linear-gradient(100deg, var(--brand), #0d2e1f)" }}>
          <div>
          ...
          <Link className="btn hover:translate-y-[-1px] transition duration-200" href="/become-a-provider" style={{ background: "#fff", color: "var(--forest)" }}>
            Become a provider →
          </Link>
        </div>
      </section>
